...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    ...
    :secret      => 'abdbafd76f229b5ac1999b66d83ccb10b02d501a'
  }
...
Radiant::Config['dev.host'] = 'preview.jcya.org'
Radiant::Config['admin.title'] = 'JCYA'
Radiant::Config['admin.subtitle'] = 'Youth Football League'
Radiant::Config['local.timezone'] = 'Central Time (US & Canada)'
